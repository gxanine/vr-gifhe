...
public class OVRDebugInfo : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        rectTransform.localScale = new Vector3(0.0006f, 0.0005f, 0.001f);
        rectTransform.localPosition = new Vector3(0.02f, -0.07f, 0.55f);
        rectTransform.localEulerAngles = new Vector3(16.6f, 332.8701f, 1.336356e-06f);
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(key) && riftPresentTimeout < 0.0f)
        {
    ...
    GameObject VariableObjectManager(GameObject gameObject, string name, float posY, string str, int fontSize)
    {
        ...
        rectTransform.localPosition = new Vector3(-350.0f, posY -= offsetY, 0.0f);
    ...
    GameObject ComponentComposition(GameObject GO)
    {
        ...
        GO.GetComponent<RectTransform>().sizeDelta = new Vector2(350f, 55f);
        GO.GetComponent<Image>().color = new Color(100f / 255f, 45f / 150f, 91f / 255f, 200f / 255f);
